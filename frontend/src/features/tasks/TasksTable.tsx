    ...
    <div className="overflow-x-auto rounded border">
      <table className="min-w-full">
        <thead className="bg-slate-100 text-left text-xs uppercase">
          <tr><th className="p-2"/><th className="p-2">Тема</th><th className="p-2">Задача</th><th className="p-2">Исполнитель</th><th className="p-2">Срок</th><th className="p-2">Статус</th><th className="p-2">Фрагмент</th></tr>
        </thead>
